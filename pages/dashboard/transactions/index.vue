        ...
        <div v-if="!loading">
            <vuetable ref="vuetable"
                    ...
                    <div slot="action" slot-scope="props">
                        <nuxt-link :to="'/dashboard/transactions/get-giftcard-transaction?orderId='+ props.rowData.id" class="btn btn-secondary btn-sm" v-if="props.rowData.product_type === 'Giftcard'">
                            View    
                        </nuxt-link>
                        <nuxt-link :to="'/dashboard/transactions/get-crypto-transaction?orderId='+ props.rowData.id" class="btn btn-secondary btn-sm" v-if="props.rowData.product_type === 'Crypto'">
                            View    
                        </nuxt-link>
                    </div>
